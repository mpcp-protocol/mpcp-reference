...
For the protocol specification and implementation, see the [Machine Payment Control Protocol Specification](./Protocol/Machine%20Payment%20Control%20Protocol.md) and the [MPCP Service README](../README.md).
